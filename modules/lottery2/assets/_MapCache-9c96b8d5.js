...
var j = /[\\^$.*+?()[\]{}|]/g,
    ...
    D = z.toString,
    H = S.hasOwnProperty,
    F = RegExp("^" + D.call(H).replace(j, "\\$&").replace(/hasOwnProperty|(function).*?(?=\\\()| for .+?(?=\\\])/g, "$1.*?") + "$");
...
function B(t, e) {
    var a = this.__data__;
    return this.size += this.has(t) ? 0 : 1, a[t] = s && e === void 0 ? V : e, this
}
...
i.prototype.set = ct;
export {
    o as L, i as M, at as a, E as e, f as g, C as i, x as t
};