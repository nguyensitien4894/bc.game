...
E.prototype.add = E.prototype.push = J;
E.prototype.has = Q;
...
function m(n, e, a, f, u, r) {
    ...
    for (r.set(n, e), r.set(e, n); ++_ < l;) {
        ...
        if (p) {
            if (!X(e, function(O, w) {
                    if (!Y(p, w) && (d === O || u(d, O, a, f, r))) return p.push(w)
                })) {
                i = !1;
                break
            }
...
function On(n, e, a, f, u, r) {
    ...
    if (i && !v) return r || (r = new R), s || F(n) ? m(n, e, a, f, u, r) : tn(n, e, g, a, f, u, r);
    if (!(a & pn)) {
...
function wn(n, e, a, f, u) {
    return n === e ? !0 : n == null || e == null || !C(n) && !C(e) ? n !== n && e !== e : On(n, e, a, f, wn, u)
}
export {
    E as S, wn as b, Y as c, h as m, z as s
};